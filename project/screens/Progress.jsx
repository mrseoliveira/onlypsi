// Progress — patient's own progress over time

function Progress({ goTo }) {
  ...
  return (
    <>
      <PageHead
        ...
        sub="Estes números vêm dos questionários que tens respondido. Ajudam-nos a ti e à tua terapeuta a ver padrões — mas só tu sabes como te sentes por dentro."
      />

      {/* Highlight cards */}
      <div className="progress-stats">
        <StatCard
          eyebrow="Bem-estar geral"
          value="3,7"
          unit="/ 5,0"
          delta="+43%"
          deltaTone="done"
          sub="média de 4 semanas · Core-OM"
          tone="accent"
        />
        <StatCard
          eyebrow="Ansiedade"
          ...
          delta="−42%"
          deltaTone="done"
          sub="Inventário de Estado Emocional"
          tone="plain"
        />
        <StatCard
          eyebrow="Sono"
