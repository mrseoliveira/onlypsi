// Therapist data — Dra. Ana Sofia Martins's caseload
...
const PATIENTS = [
  ...
  {
    id: "p2", name: "Diogo André Sousa", initials: "DS", age: 28,
    since: "Janeiro 2025", sessions: 10, nextSession: "Hoje · 15:00",
    status: "em_progresso", focus: "Regulação emocional",
    moodTrend: [2.8, 2.7, 2.5, 2.4, 2.0, 1.8, 1.6],
    risk: "elevado",
    alert: "Termómetro Emocional vermelho · ontem",
    pendingForms: 0,
  },
  {
    id: "p3", name: "Carolina Teixeira Pinto", initials: "CP", age: 41,
    since: "Março 2026", sessions: 3, nextSession: "Hoje · 14:00",
    status: "primeira_fase", focus: "Stress pós-trauma",
    moodTrend: [1.8, 1.9, 2.1, 2.0, 2.2],
    risk: "moderado",
    pendingForms: 1,
  },
  {
    id: "p4", name: "Pedro Henrique Santos", initials: "PS", age: 23,
    since: "Maio 2026", sessions: 0, nextSession: "Hoje · 11:30",
    status: "primeira_consulta", focus: "Triagem inicial",
    moodTrend: [],
    risk: "indefinido",
    alert: "Primeira consulta",
    pendingForms: 0,
  },
  {
    id: "p5", name: "Inês Duarte Oliveira", initials: "IO", age: 35,
    since: "Setembro 2024", sessions: 21, nextSession: "21 Mai · 10:00",
    status: "manutencao", focus: "Manutenção · ansiedade social",
    moodTrend: [3.2, 3.5, 3.7, 3.8, 4.0, 4.1, 4.2],
    risk: "baixo",
    pendingForms: 0,
  },
  {
    id: "p6", name: "Tomás Manuel Ferreira", initials: "TF", age: 19,
    since: "Fevereiro 2026", sessions: 8, nextSession: "21 Mai · 09:00",
    status: "em_progresso", focus: "Transição académica",
    moodTrend: [2.0, 2.2, 2.5, 2.6, 2.8, 2.9, 3.0],
    risk: "baixo",
    pendingForms: 1,
  },
  {
    id: "p7", name: "Sofia Alexandra Correia", initials: "SC", age: 47,
    since: "Agosto 2024", sessions: 24, nextSession: "16 Mai · 11:00",
    status: "manutencao", focus: "Luto · 2º ano",
    moodTrend: [3.0, 3.1, 3.0, 3.2, 3.3, 3.5, 3.4],
    risk: "baixo",
    pendingForms: 0,
  },
  {
    id: "p8", name: "Rafael Gomes Teixeira", initials: "RT", age: 38,
    since: "Novembro 2024", sessions: 11, nextSession: "17 Mai · 17:00",
    status: "em_progresso", focus: "Conflito relacional",
    moodTrend: [2.4, 2.5, 2.3, 2.6, 2.7, 2.9, 3.0],
    risk: "moderado",
    pendingForms: 2,
    alert: "Faltou à última sessão",
  },
  {
    id: "p9", name: "Joana Figueiredo Cardoso", initials: "JC", age: 29,
    since: "Janeiro 2026", sessions: 6, nextSession: "18 Mai · 14:00",
    status: "em_progresso", focus: "Burnout",
    moodTrend: [1.8, 2.0, 2.2, 2.4, 2.6],
    risk: "moderado",
    pendingForms: 1,
  },
  {
    id: "p10", name: "André Filipe Nunes", initials: "AN", age: 52,
    since: "Junho 2024", sessions: 28, nextSession: "20 Mai · 16:00",
    status: "manutencao", focus: "Manutenção · ansiedade generalizada",
    moodTrend: [3.5, 3.6, 3.8, 3.7, 3.9, 4.0, 3.9],
    risk: "baixo",
    pendingForms: 0,
  },
  {
    id: "p11", name: "Carolina Barros Fernandes", initials: "CF", age: 26,
    since: "Pausa desde Março", sessions: 14, nextSession: "—",
    status: "pausa", focus: "Em pausa terapêutica",
    moodTrend: [2.8, 3.0, 3.2],
    risk: "baixo",
    pendingForms: 0,
  },
  {
    id: "p12", name: "Mariana Pinto Ribeiro", initials: "MR", age: 34,
    since: "Outubro 2025", sessions: 16, nextSession: "19 Mai · 18:00",
    status: "em_progresso", focus: "Self-compaixão",
    moodTrend: [2.5, 2.6, 2.8, 3.0, 3.1, 3.2, 3.4],
    risk: "baixo",
    pendingForms: 0,
  },
];

// ─── Alerts (clinical signals) ──────────────────────────────────────
const ALERTS = [
  {
    id: "a1", level: "high", patientId: "p2",
    title: "Termómetro Emocional em vermelho",
    detail: "Diogo André Sousa marcou 1/5 no termómetro de entrada ontem à noite.",
    timeAgo: "há 14h",
    action: "Rever antes das 15:00",
  },
  {
    id: "a2", level: "medium", patientId: "p8",
    title: "Falta consecutiva",
    detail: "Rafael Gomes Teixeira não compareceu na última sessão (7 Mai) e não respondeu ao pedido de remarcação.",
    timeAgo: "há 3 dias",
    action: "Contactar",
  },
  {
    id: "a3", level: "medium", patientId: "p1",
    title: "Questionários por responder",
    detail: "Beatriz Lopes Carvalho tem 3 questionários pré-sessão pendentes para hoje às 16:00.",
    timeAgo: "há 5h",
    action: "Notificar",
  },
  {
    id: "a4", level: "low", patientId: "p9",
    title: "Core-OM em descida",
    detail: "Joana Figueiredo Cardoso desceu de 2.6 → 2.0 nas últimas duas semanas.",
    timeAgo: "há 1 dia",
    action: "Acompanhar",
  },
];
...
// ─── Single patient detail (Beatriz, since we built patient view of her) ────
...
// ─── Questionnaire library (therapist view) ─────────────────────────
const QUESTIONNAIRE_LIBRARY = [
...
// ─── Week agenda (for sessions screen) ──────────────────────────────
const WEEK_DAYS = [
...
const WEEK_SESSIONS = {
  ...
  "14": TODAYS_SESSIONS.map(s => ({ time: s.time, patient: s.patient, initials: s.initials, topic: s.topic, mode: s.mode, status: s.status, alert: s.alert })),
  "15": [
...
Object.assign(window, {
  THERAPIST, TODAY, TODAYS_SESSIONS, PATIENTS, ALERTS, ACTIVITY,
  PATIENT_DETAIL, QUESTIONNAIRE_LIBRARY, WEEK_DAYS, WEEK_SESSIONS,
});
